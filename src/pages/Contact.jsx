    ...
    <Container className="vw-vh d-flex justify-content-center align-items-center">
      <div className="w-100 flex-grow-1 flex-shrink-1">
        ...
        <Container className="d-flex flex-column justify-content-center align-items-start contact-links">
          <ContactLinks link="https://www.github.com/eddyK15501" title="https://www.github.com/eddyK15501">
            <AiOutlineGithub size={40} style={{ marginRight: "0.5rem" }} />
          </ContactLinks>

          <ContactLinks link="https://www.linkedin.com/in/edwardkim1231" title="https://www.linkedin.com/in/edwardkim1231">
            <AiOutlineLinkedin size={40} style={{ marginRight: "0.5rem" }} />
          </ContactLinks>

          <ContactLinks link="mailto:fifteenbackwoods501@gmail.com" title="fifteenbackwoods501@gmail.com">
            <MdOutlineAlternateEmail size={35} style={{ marginLeft: "0.1rem", marginRight: "0.7rem" }} />
          </ContactLinks>
        </Container>
      </div>

      <Form className="w-100 flex-grow-1 flex-shrink-1" style={{ padding: '2rem 7.5rem 0' }}>
        <InputGroup>
